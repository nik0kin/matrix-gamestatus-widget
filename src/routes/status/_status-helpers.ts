  ...
  return friends.sort((f1, f2) => {
    if (
      (f1.personastate === PersonaState.ONLINE &&
        ...
        f2.gameid) ||
      (f1.personastate === PersonaState.ONLINE && f2.personastate === PersonaState.ONLINE) ||
      (f1.personastate === PersonaState.AWAY && f2.personastate === PersonaState.AWAY)
    ) {
      return f1.personaname.localeCompare(f2.personaname);
    }
